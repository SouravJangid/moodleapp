...
$string['invalidphoneformat'] = 'Invalid mobile number. Please enter a 10-digit Indian number starting with 6, 7, 8, or 9 (e.g., +919876543210).';
...
$string['missingphone'] = 'Mobile number is required.';
...
$string['missingphone'] = 'Mobile number is required.';
$string['invalidphoneformat'] = 'Invalid mobile number. Please enter a valid number for the selected country.';
$string['missingcountrycode'] = 'Country code is required.';
$string['phone_help'] = 'Enter your mobile number in the format required for that country (e.g., +91 9876543210 for India, +86 12345678901 for China).';
$string['usernameemailmatch'] = 'The username must match the email address.';
$string['countrycode'] = 'Country Code';

$string['countrycode_help'] = 'Choose your Country Code';

$string['invalidphonelength'] = 'Phone number must be {length} digits long';
$string['phonenumberinuse'] = 'This phone number is already in use';

$string['requiredotp'] = 'Please enter the OTP';
$string['missingotp'] = 'Please enter the OTP.';
$string['invalidotpformat'] = 'The OTP entered is invalid.';
$string['phonechanged'] = 'Phone number has changed. Please request a new OTP.';
$string['otpverificationfailed'] = 'OTP verification failed';
$string['otp'] = 'Enter OTP';
$string['otpexpired'] = 'The OTP has expired. Please request a new one.';
$string['toomanyattempts'] = 'Too many failed attempts (3/3). Please request a new OTP.';
$string['otpverified'] = 'OTP verified successfully! Account creation can proceed.';
