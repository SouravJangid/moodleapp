...
$PAGE->requires->css('/theme/boost/scss/signup.scss'); // Added CSS dependency for login-view styling
...
// Custom login view from signup.php
?>
<style>
    .loginform {
        display: flex;
...
<div class="login-view"> 
    <div class="images">
        <img src="<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/1.png" alt="" class="login-image">
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const images = [
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/1.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/2.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/3.png"
        ];
