...
//extra
$string['otpverificationfailed'] = 'OTP verification failed: {$a}';
$string['otpverified'] = 'OTP verified successfully!';
$string['invalidotp'] = 'Invalid OTP provided. Please try again.';
...
$string['toomanyattempts'] = 'Too many OTP attempts. Please start over.';
$string['missingotp'] = 'Please enter the OTP.';
$string['invalidotpformat'] = 'OTP must be a 6-digit number.';
$string['missingphone'] = 'Please enter your phone number.';
$string['invalidphoneformat'] = 'Phone number must be 10-15 digits.';
$string['missingcountrycode'] = 'Please select a country code.';
