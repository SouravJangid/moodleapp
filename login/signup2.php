...
$PAGE->set_url('/login/signup2.php');
$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('login');
$PAGE->set_title(get_string('newaccount'));
$PAGE->set_heading($SITE->fullname);
$PAGE->requires->css('/theme/boost/scss/signupgraduation.scss');
...
<div class="login-view"> 
    <div class="images">
        <img src="<?php echo $CFG->wwwroot; ?>/theme/boost/pix/bg31.png" alt="" class="login-image static-image">
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const backgroundImages = [
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/stg1.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/stg2.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/stg3.png"
        ];
        ...
        if (messageElement && imagesContainer) {
            setInterval(() => {
                messageElement.textContent = messages[index];
                imagesContainer.style.backgroundImage = `url(${backgroundImages[index]})`;
