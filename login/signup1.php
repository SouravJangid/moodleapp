...
$PAGE->requires->css('/theme/boost/scss/student.scss');
...
// Custom login view
?>
<div class="login-view-student"> 
    <div class="images">
        <img src="<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/st1.png" alt="" class="login-image">
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const images = [
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/st1.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/st2.png",
            "<?php echo $CFG->wwwroot; ?>/theme/boost/pix/images/st3.png"
        ];
